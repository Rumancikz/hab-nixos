...

{
  ...
  # Users
  # Note: Passwords are managed via sops-nix (see ./secrets.nix)
  # The hashedPasswordFile option is set in secrets.nix
  users = {
    mutableUsers = false;
    users = {
      root = {
        ...
        # Password managed by sops-nix - see ./secrets.nix
      };
      hab-lab = {
        openssh.authorizedKeys.keys = [
          "ssh-rsa  zach5@Glacier"
